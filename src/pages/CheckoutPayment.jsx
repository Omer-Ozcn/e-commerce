    ...
    <main className="bg-[#FAFAFA] min-h-[60vh]">
      ...
      <section className="max-w-6xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-[1fr,320px] gap-6">
        <div className="lg:pr-2">
          ...
          <div className="bg-white border rounded-lg mt-6 p-5">
            <h3 className="text-lg font-bold text-[#252B42] mb-3">Taksit Seçenekleri</h3>
            <div className="border rounded p-3 text-[#252B42] flex justify-between">
              <span>Tek Çekim</span>
              <span className="font-bold">Sepet toplamı</span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:pl-2">
          <div className="lg:sticky lg:top-24">
            ...
            <button
              ...
              onClick={() => alert("Ödeme akışı: seçili kartla işleme devam edilecek.")}
            >
              Ödeme Yap
            </button>
          </div>
