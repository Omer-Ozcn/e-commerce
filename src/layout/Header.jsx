...
const trToAscii = (s = "") => s.replace(/[ıİşŞğĞçÇöÖüÜ]/g, (ch) => ({
...
export default function Header() {
  ...
  const openShop = () => { if (closeTimer.current) clearTimeout(closeTimer.current); setIsShopOpen(true); };
  const scheduleClose = () => {
      ...
      <div className="hidden md:flex justify-between items-baseline px-10 py-5 shadow-md">
        ...
        <div className="flex items-center gap-4 text-[#252B42]">
          ...
          <div className="relative">
            <button onClick={() => {}} className="flex gap-1 items-center cursor-pointer" title="Cart">
              <ShoppingCart />
